...
- PI no FIFO: mean RMS jitter = 7.77 us, mean P95 abs jitter = 18.32 us, mean P99 abs jitter = 33.26 us, mean CV = 0.08%
...
PI no FIFO: mean PI steady-state error across valid targets = 6.08 RPM.
