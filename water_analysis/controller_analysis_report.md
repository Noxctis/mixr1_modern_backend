...
The current open-loop settled data has an approximate linear steady-state fit of RPM = 24.94 * PWM(%) + -24.77. This is a static characterization, not the dynamic first-order model by itself.

PI FIFO: mean PI steady-state error across valid targets = 17.00 RPM.
